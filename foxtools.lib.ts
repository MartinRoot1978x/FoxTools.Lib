...
module foxtools {
	...
	export module lib {
		...
		export class client {
			 ...
			 */
			static getToken(url: any, options?: any): string {
				var token = null;
			 ...
			 */
			static foxyForm(selector?: string|HTMLFormElement|JQuery, options?: requestProcess): void {
		...
		export class httpParameterCollection {
			 ...
			 */
			public add(name: string|HTMLElement|JQuery, value?: any) {
		...
		export class httpParameter {
			 ...
			 * @param value Значение параметра.
			 */
			constructor(name: string|HTMLElement|JQuery, value?: any) {
				...
				if (utility.isElement(name)) {
					...
					if ((<JQuery>name).length) {
						this.name = (<JQuery>name).attr('name');
						this.setValue(name);
					} else {
		...
		export class foxtoolsToken {
			 ...
			 */
			static parse(token: any): foxtoolsToken {
		...
		class ya {
			 ...
			 */
			static hit(url: string, title?: string): void {
				try {
					//utility.initYa();
	...
	export class utility {
		 ...
		 */
		static getQueryStringParameterByName(name: string, queryString?: string): string {
	 ...
	 * @param options Дополнительные параметры.
	 */
	export function apiForm(selector: string|HTMLFormElement|JQuery, options?: foxtools.lib.requestProcess): void {
	 ...
	 * @param methodName Название метода, который необходимо выполнить.
	 */
	export function apiRequest(methodName: string): foxtools.lib.request {
